...
syn match autoItLibrary             "\c\<\(Auto It Set Option\|Block Input\|CD Tray\|Clip Get\|Clip Put\|Control Click\|Control Command\|Control Disable\|Control Enable\|Control Focus\|Control Get Focus\|Control Get Handle\|Control Get Pos Height\|Control Get Pos Width\|Control Get Pos X\|Control Get Pos Y\|Control Get Text\|Control Hide\|Control List View\|Control Move\|Control Send\|Control Set Text\|Control Show\|Control Tree View\|Drive Map Add\|Drive Map Del\|Drive Map Get\|Get Active Window Image\|Get Auto It Version\|Get Screen Image\|Get Version\|Ini Delete\|Ini Read\|Ini Write\|Init\|Is Admin\|Mouse Click Drag\|Mouse Click\|Mouse Down\|Mouse Get Cursor\|Mouse Get Pos X\|Mouse Get Pos Y\|Mouse Move\|Mouse Up\|Mouse Wheel\|Opt\|Pixel Checksum\|Pixel Get Color\|Pixel Search\|Process Close\|Process Exists\|Process Set Priority\|Process Wait Close\|Process Wait\|Reg Delete Key\|Reg Delete Val\|Reg Enum Key\|Reg Enum Val\|Reg Read\|Reg Write\|Run As Set\|Run Wait\|Run\|Send\|Shutdown\|Statusbar Get Text\|Tool Tip\|Wait For Active Window\|Win Activate\|Win Active\|Win Close\|Win Exists\|Win Get Caret Pos X\|Win Get Caret Pos Y\|Win Get Class List\|Win Get Client Size Height\|Win Get Client Size Width\|Win Get Handle\|Win Get Pos Height\|Win Get Pos Width\|Win Get Pos X\|Win Get Pos Y\|Win Get Process\|Win Get State\|Win Get Text\|Win Get Title\|Win Kill\|Win List\|Win Menu Select Item\|Win Minimize All Undo\|Win Minimize All\|Win Move\|Win Set On Top\|Win Set State\|Win Set Title\|Win Set Trans\|Win Wait Active\|Win Wait Close\|Win Wait Not Active\|Win Wait\)\>"
...
hi def link autoItLibrary           Keyword
