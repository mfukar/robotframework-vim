...
" Table headers
syn match robotTable            "\c^\(\*\+\)\s*\(setting\|settings\|metadata\|variable\|variables\|testcase\|testcases\|test case\|test cases\|\(user \)\?keyword\|\(user \)\?keywords\)\s*\1$"
" Builtins
...
" Links
"------------------------------------------------------------------------
hi def link robotVariableScalar   Type
hi def link robotVariableList     Type
